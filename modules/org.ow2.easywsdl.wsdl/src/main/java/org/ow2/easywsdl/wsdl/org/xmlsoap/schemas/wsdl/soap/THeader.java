...
/**
 * <p>Classe Java pour tHeader complex type.
 * 
    ...
    implements Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof THeader) {
            final THeader copy = ((THeader) draftCopy);
            {
                Boolean headerfaultShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, ((this.headerfault!= null)&&(!this.headerfault.isEmpty())));
                if (headerfaultShouldBeCopiedAndSet == Boolean.TRUE) {
                    List<THeaderFault> sourceHeaderfault;
                    sourceHeaderfault = (((this.headerfault!= null)&&(!this.headerfault.isEmpty()))?this.getHeaderfault():null);
                    @SuppressWarnings("unchecked")
                    List<THeaderFault> copyHeaderfault = ((List<THeaderFault> ) strategy.copy(LocatorUtils.property(locator, "headerfault", sourceHeaderfault), sourceHeaderfault, ((this.headerfault!= null)&&(!this.headerfault.isEmpty()))));
                    copy.headerfault = null;
                    if (copyHeaderfault!= null) {
                        List<THeaderFault> uniqueHeaderfaultl = copy.getHeaderfault();
                        uniqueHeaderfaultl.addAll(copyHeaderfault);
                    }
                } else {
                    if (headerfaultShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.headerfault = null;
                    }
                }
            }
