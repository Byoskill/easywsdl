 ...
 *       
 * 
 * <p>Classe Java pour DocumentedType complex type.
 * 
...
public class DocumentedType implements Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof DocumentedType) {
            final DocumentedType copy = ((DocumentedType) draftCopy);
            {
                ...
                if (documentationShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    List<DocumentationType> copyDocumentation = ((List<DocumentationType> ) strategy.copy(LocatorUtils.property(locator, "documentation", sourceDocumentation), sourceDocumentation, ((this.documentation!= null)&&(!this.documentation.isEmpty()))));
