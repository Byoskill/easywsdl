        ...
        if (draftCopy instanceof TBinding) {
            final TBinding copy = ((TBinding) draftCopy);
            {
                ...
                if (operationShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    List<TBindingOperation> copyOperation = ((List<TBindingOperation> ) strategy.copy(LocatorUtils.property(locator, "operation", sourceOperation), sourceOperation, ((this.operation!= null)&&(!this.operation.isEmpty()))));
                    copy.operation = null;
